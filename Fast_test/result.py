...
import numpy as np
import pandas as pd
from fast_test import test_optimized
#7715
epsilon=[]
S=[]
for i in range(1, 7716):
    try:
        with open(f"/mnt/c/CV/FSC147B5/yolo_labels/{i}.txt", 'r') as f:
            A = []
            for lines in f:
            ...
            image_RGB = cv2.imread(f'/mnt/c/CV/FSC147B5/images_384_VarV2/{i}.jpg')
